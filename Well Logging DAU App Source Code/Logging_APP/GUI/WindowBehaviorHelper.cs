...
namespace Logging_App.GUI
{
    public class WindowBehaviorHelper
    {
        ...
        private int WidthCorner = 5;                //拐角宽度
        private int ThicknessTransparentBorder = 0; //透明宽度
        private int ThicknessBorder = 3;            //边框宽度
        ...
        public enum HitTest : int                   //测试句柄
        {
            ...
            HTCLOSE = 20,
            HTHELP = 21,
            WM_LBUTTONUP = 0x202fffe,
            WM_LBUTTONDOWN = 0x201fffe
            #endregion
        }
